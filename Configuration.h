...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3 Pro/BigTreeTech SKR 1.3"
...
#define CUSTOM_MACHINE_NAME "Creality ex. cfg. 1.4"
...
#define TEMP_SENSOR_BED 1  //Was 1....then found set to 55
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 145.31
  #define DEFAULT_bedKi 29.03
  #define DEFAULT_bedKd 484.86
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 141 } //E (141) was 99.5
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 25 } //{ 1000, 1000, 360, 100 } //Z was 90
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 5000 } //{ 3000, 3000, 1000, 10000 } //Z was 100
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -13, -1.40 } //Z was -1 <--older newer--> 0.6
 ...
 */
#define MULTIPLE_PROBING 2  //Was disabled
...
#define Z_AFTER_PROBING           10 // Z position after probing is done //Was 5 and disabled
...
#define HOMING_FEEDRATE_MM_M { (50*80), (50*80), (5*80) } //{ (50*60), (50*60), (5*60) }
