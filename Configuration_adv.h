...
//#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 1.4 //0.20    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       800 //760        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  128 // 8
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  128 // 8
